...
export default function MaternityLeaveReportPage() {
  ...
  const derived = useMemo(() => {
    ...
    const rows = (list || [])
      .filter(hr => khContains(hr.civilServantReason, keywords))
  ...
  const handleExportExcel = () => {
    const header = ['ល.រ','អត្តលេខមន្រ្តីរាជការ','គោត្តនាម-នាម','ភេទ','ថ្ងៃខែឆ្នាំកំណើត','ផ្នែក','មុខងារ','កាំប្រាក់','មូលហេតុ'];
    ...
    ws['!cols'] = [{wch:5},{wch:18},{wch:28},{wch:6},{wch:14},{wch:16},{wch:20},{wch:10},{wch:30}];
  ...
  if (!perms.canViewHR) {
    return (
      <div className="p-6">
        <h2 className="text-xl font-semibold mb-2">របាយការណ៍ សម្រាកមាតុភាព</h2>
